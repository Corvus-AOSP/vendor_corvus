...
ifneq ($(filter begonia raphael enchilada lavender mido wayne whyred platina ginkgo vince tulip beryllium violet X00T RMX1801 tissot x2 jasmine_sprout sirius grus kenzo davinci,$(corvus_device)),)
scr_resolution := 1080
endif
